...
class EventOrganizerApi {
  ...
  const EventOrganizerApi(this._dio, this._serializers);
  ...
  Future<Response<Organizer>> confirm({ 
    ...
    final _path = r'/organizer/{id}'.replaceAll('{' r'id' '}', id.toString());
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteOrganizer({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  ///
  /// Parameters:
  /// * [email] - The organizer email for login
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [LoginOrganizer200Response] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<LoginOrganizer200Response>> loginOrganizer({ 
    ...
    return Response<LoginOrganizer200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
